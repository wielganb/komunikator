...
class MainActivity : AppCompatActivity() {
    ...
    private fun showLogin() {
        ...
        applySafeInsets(root, 20, 20, 20, 20)
    ...
    private fun showConversations() {
        ...
        applySafeInsets(root, 14, 14, 14, 14)
        ...
        header.addView(title, LinearLayout.LayoutParams(0, 62, 1f))

        val add = iconButton("+", 27f)
        header.addView(add, LinearLayout.LayoutParams(60, 60))
    ...
    private fun showChat() {
        ...
        top.addView(avatar("E", 52), LinearLayout.LayoutParams(52, 52).apply {
            leftMargin = 6
        })
        ...
        top.addView(userInfo, LinearLayout.LayoutParams(0, 68, 1f))
        ...
        root.addView(top, LinearLayout.LayoutParams(-1, 78))
    ...
    private fun addBubble(message: String, outgoing: Boolean, uri: Uri?) {
        ...
        val lp = LinearLayout.LayoutParams(
            ...
            setMargins(
                if (outgoing) 28 else 4,
                1,
                if (outgoing) 4 else 28,
                12
            )
        }
