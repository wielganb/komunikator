...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // system-bar and keyboard insets so no header/title can hide underneath them.
    ...
    private fun showConversations() {
        ...
        applySafeInsets(root, 10, 10, 10, 12)
    ...
    private fun showChat() {
        ...
        root.addView(top, LinearLayout.LayoutParams(-1, -2).apply { bottomMargin = 7 })
